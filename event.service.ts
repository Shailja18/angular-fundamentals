...
{
    //We could inject this service to component
    getEvents():Observable<IEvent[]>
    {
      //Observables are like streams of data
      //they are kind of arrays where data arrives over tym.
      //Angular is designed very well to work with both observables and promises very well
      //Subject is type of variable we are doing after 100ms we are adding data to streams
